...
struct command accel_sensor_subcommands[] = {
	{
		.name = "init",
		.help = "accel_sensor setup",
		.handler = cmd_accel_sensor_init,
	},{
		.name = "test",
		.help = "accel_sensor test",
		.handler = cmd_accel_sensor_test,
	},
};
...
struct command __root_command panels_commands[] = {
	{
		...
		.name = "accel_sensor",
		.help = "accel_sensor commands",
		.chain = INIT_CHAIN(accel_sensor_subcommands),
	}
};
